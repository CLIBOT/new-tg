...
elseif lang then
return "لینک در گروه از قبل قفل نبوده "
end
else 
...
if not lang then
 ...
 return "⚠️شما مدیر گروه نمیباشید⚠️⚠️"
end
end
...
elseif lang then
 return "اارسال پست های ویو دار قفل شد"
end
else
...
if not lang then
 ...
 return "ارسال پست ویو دار قفل شده بود"
end
end
end
...
elseif lang then
return "قفل پست ویو دار فعال نیست"
end
else 
